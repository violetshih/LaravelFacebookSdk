...
[![Build Status](https://img.shields.io/travis/Violetshih/LaravelFacebookSdk.svg)](https://travis-ci.org/Violetshih/LaravelFacebookSdk)
[![Latest Stable Version](https://img.shields.io/packagist/v/Violetshih/laravel-facebook-sdk.svg?maxAge=2592000)](https://packagist.org/packages/Violetshih/laravel-facebook-sdk)
[![Total Downloads](https://img.shields.io/packagist/dt/Violetshih/laravel-facebook-sdk.svg)](https://packagist.org/packages/Violetshih/laravel-facebook-sdk)
[![License](https://img.shields.io/badge/license-MIT-lightgrey.svg)](https://github.com/Violetshih/LaravelFacebookSdk/blob/master/LICENSE)
...
[![Laravel 5](http://Violetshih.s3.amazonaws.com/open-source/laravel-facebook-sdk/laravel-5.png)](http://laravel.com/docs)

[![Lumen 5](http://Violetshih.s3.amazonaws.com/open-source/laravel-facebook-sdk/lumen-5.png)](https://lumen.laravel.com/docs)

- _For Laravel 4.2, [see the 1.3 branch](https://github.com/Violetshih/LaravelFacebookSdk/tree/1.3)._
...
This example also demonstrates how to [exchange a short-lived access token with a long-lived access token](https://www.Violetshih.me/access-token-handling-best-practices-in-facebook-php-sdk-v4) and save the user to your `users` table if the entry doesn't exist.
...
Please see [CONTRIBUTING](https://github.com/Violetshih/LaravelFacebookSdk/blob/master/CONTRIBUTING.md) for details.


## Credits

This package is maintained by [Sammy Kaye Powers](https://github.com/Violetshih). See a [full list of contributors](https://github.com/Violetshih/LaravelFacebookSdk/contributors).


## License

The MIT License (MIT). Please see [License File](https://github.com/Violetshih/LaravelFacebookSdk/blob/master/LICENSE) for more information.
